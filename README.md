...
### 4. 테스트케이스 → 버그 리포트
<img src="./tcgenerator/img/5.png" width="800">

실패한 테스트케이스 + 실제 결과 + 버전 정보를 넣으면 Yona에 바로 붙여넣을 수 있는 버그 리포트로 변환합니다. CLI·GUI 모두 지원.

### 5. 커버리지 분석
<img src="./tcgenerator/img/2.png" width="800">
